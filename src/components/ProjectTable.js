...
ProjectTable.defaultProps = {
    ...
    columns: [
        ...
        {field: 'name', headerName: 'Name', width: 200, headerClassName: 'projectsTableHeader', cellClassName: 'informationFont'},
        {field: 'description', headerName: 'Description', width: 690, headerClassName: 'projectsTableHeader', cellClassName: 'informationFont'},
        {field: 'creationDate', headerName: 'Created', width: 145, headerClassName: 'projectsTableHeader', cellClassName: 'informationFont'},
        {field: 'language', headerName: 'Language', width: 120, headerClassName: 'projectsTableHeader', cellClassName: 'informationFont'},
        {
            field: 'repo',
            headerName: 'Repo',
